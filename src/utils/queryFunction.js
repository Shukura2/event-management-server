...
export const dropAttendeesTables = () => executeQueryArray([ dropAttendeesTable ]);
export const dropEventTables = () => executeQueryArray([ dropEventTable ]);
export const dropEventCategoryTables = () => executeQueryArray([ dropEventCategoryTable ]);
...
export const createEventCategoriesTable = () => executeQueryArray([ createEventCategoryTable ]);
